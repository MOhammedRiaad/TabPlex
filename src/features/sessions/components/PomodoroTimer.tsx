    ...
    return (
        <div className="pomodoro-timer">
            <div className="timer-header">
                ...
                <button className="settings-btn" onClick={() => setShowSettings(!showSettings)} aria-label="Settings">
                    ⚙️
                </button>
            </div>
            ...
            <div className="timer-modes">
                <button className={`mode-btn ${mode === 'work' ? 'active' : ''}`} onClick={() => setMode('work')}>
                    Work
                </button>
                <button
            ...
            <div className="linked-task-section">
                {linkedTask ? (
                    ...
                    <button className="link-task-btn" onClick={() => setShowTaskPicker(!showTaskPicker)}>
                        🔗 Link a Task
                    </button>
                )}
                        ...
                        <div className="task-list">
                            {activeTasks.length > 0 ? (
                                activeTasks.map(task => (
                                    <button key={task.id} className="task-option" onClick={() => linkTask(task)}>
